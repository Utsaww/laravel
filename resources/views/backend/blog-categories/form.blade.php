<div class="card-body">
    ...
    <div class="row mt-4 mb-4">
        <div class="col">
            ...
            <div class="form-group row">
                {{ Form::label('type', 'Type', ['class' => 'col-md-2 from-control-label required']) }}

                <div class="col-md-10">
                    {{ Form::select('type', class_type_array(), null, ['class' => 'form-control select2 status box-size', 'placeholder' => 'Type', 'required' => 'required']) }}
                </div>
                <!--col-->
            </div>
            <!--form-group-->
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    <div class="checkbox d-flex align-items-center">
                        ...
                        {{ (!isset($blogCategory->status) ||(isset($blogCategory->status) && $blogCategory->status)) ? "checked" : "" }}><span class="switch-slider" data-checked="on" data-unchecked="off"></span></label>
                    </div>
                </div><!--col-->
            </div><!--form-group-->
        </div><!--col-->
